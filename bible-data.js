...
const TORAH_BOOKS = [
  // Bundled KRV chapter boundaries, used to merge reading ranges without loading verse text.
  { id: 'Gen', name: '창세기', chapters: 50, verseCounts: [31,25,24,26,32,22,24,22,29,32,32,20,18,24,21,16,27,33,38,18,34,24,20,67,34,35,46,22,35,43,55,32,20,31,29,43,36,30,23,23,57,38,34,34,28,34,31,22,33,26] },
  { id: 'Exod', name: '출애굽기', chapters: 40, verseCounts: [22,25,22,31,23,30,25,32,35,29,10,51,22,31,27,36,16,27,25,26,36,31,33,18,40,37,21,43,46,38,18,35,23,35,35,38,29,31,43,38] },
  { id: 'Lev', name: '레위기', chapters: 27, verseCounts: [17,16,17,35,19,30,38,36,24,20,47,8,59,57,33,34,16,30,37,27,24,33,44,23,55,46,34] },
  { id: 'Num', name: '민수기', chapters: 36, verseCounts: [54,34,51,49,31,27,89,26,23,36,35,16,33,45,41,50,13,32,22,29,35,41,30,25,18,65,23,31,40,16,54,42,56,29,34,13] },
  { id: 'Deut', name: '신명기', chapters: 34, verseCounts: [46,37,29,49,33,25,26,20,29,22,32,32,18,29,23,22,20,22,21,20,23,30,25,22,19,19,26,68,29,20,30,52,29,12] }
]; // 총 187장
